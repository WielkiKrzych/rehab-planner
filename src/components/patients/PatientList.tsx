  ...
  if (patients.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <h3 className="text-lg font-medium text-white mb-1">Brak pacjentów</h3>
        <p className="text-gray-400">Dodaj pierwszego pacjenta, aby rozpocząć.</p>
      </div>
    );
  }
    ...
    <div className="space-y-4">
      ...
      {filteredPatients.length === 0 ? (
        <div className="text-center py-12">
          <p className="text-gray-400">Nie znaleziono pacjentów pasujących do &quot;{searchQuery}&quot;</p>
        </div>
      ) : (
